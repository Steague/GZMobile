	...
	<div role="main" class="ui-content">
		...
		<?php echo Form::open('/user/register'); ?>
			<div data-role="fieldcontain">
				...
				<?php echo Form::input('username', HTML::chars(Arr::get($_POST, 'username')), array("id"=>"username_register", "placeholder"=>"Username")); ?>
			...
			<div data-role="fieldcontain">
				...
				<?php echo Form::label('password_register', Arr::path($errors, '_external.password'), array('class'=>"error", "placeholder"=>"Password")); ?>
			</div>
			<div data-role="fieldcontain">
				<?php echo Form::label('password_confirm_register', 'Confirm Password'); ?>
				<?php echo Form::password('password_confirm', null, array("id"=>"password_confirm_register", "placeholder"=>"Password")); ?>
			...
			<div data-role="fieldcontain">
				...
				<?php echo Form::input('email', HTML::chars(Arr::get($_POST, 'email')), array("id"=>"email_register", "placeholder"=>"Email")); ?>
